...
class _TrackOrdersListScreenState extends State<TrackOrdersListScreen> {
          ...
          return Padding(
            ...
            child: ChoiceChip(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(
                  color:
                      isSelected ? Colors.transparent : const Color(0xFFC4C8C1),
                  width: 0.8,
                ),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: !appState.ordersEnabled
            ? Center(
                child: Padding(
                  padding: const EdgeInsets.all(32.0),
                  child: Text(
                    'Order history is unavailable for this store.',
            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    // Elegant Header with flipped back button and title
                    Row(
                        ...
                        child: Column(
                          children: [
                            const Icon(Icons.receipt_long_outlined,
                                size: 36, color: Color(0xFF7E807C)),
                            ...
                            Text(
                              'Please access the Me profile tab to sign in or register and sync your active s, order histories, and support tickets.',
                              textAlign: TextAlign.center,
                              style: GoogleFonts.manrope(
                                fontSize: 12,
                                color: AppTheme.secondary,
                        ...
                        child: Column(
                          children: [
                            const Icon(Icons.receipt_outlined,
                                size: 40, color: Color(0xFFC2C7C4)),
                            const SizedBox(height: 16),
                            Text(
                              'No orders found',
                              style: GoogleFonts.ebGaramond(
                          ...
                          return Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 6),
                                Text(
                                  'No orders matching the "$_selectedFilter" filter were found.',
                                  textAlign: TextAlign.center,
                                  style: GoogleFonts.manrope(
                                    fontSize: 12,
                                    color: AppTheme.secondary,
